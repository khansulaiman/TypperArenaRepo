...
const getUserContest = async (req, res, next) => {
    ...
    try {
        ...
        const contest = await contest_services.getUserContest(user_id);
...
const updateParagraph = async (req, res, next) => {
    ...
    const { content, difficulty_level, typing_duration = 0 } = req.body;
    ...
    try {
        ...
        const paragraph = await contest_services.updateParagraph({
                paragraph_id,
                content,
                difficulty_level,
                typing_duration
